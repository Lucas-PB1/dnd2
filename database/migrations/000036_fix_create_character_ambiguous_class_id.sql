-- Variáveis PL/pgSQL class_id/class_level colidem com colunas de views (v_class_proficiency_details).
-- PostgreSQL não resolve o nome e lança "column reference class_id is ambiguous".

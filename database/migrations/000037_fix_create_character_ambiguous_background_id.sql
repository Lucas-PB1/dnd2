-- Variável PL/pgSQL background_id colide com background_skill_proficiencies.background_id.
-- PostgreSQL lança "column reference background_id is ambiguous".
...
BEGIN
    ...
    SELECT new_id, 'skill', sk.name, 'background', payload_background_id
